app.controller('NavController', ['$scope', '$location', 'DemoService', 'ngDialog', '$cookies', '$state', '$window', '$stateParams',
  function($scope, $location, DemoService, ngDialog, $cookies, $state, $window, $stateParams) {
